	...
	namespace constants {
		...
		*/
		namespace battery {
			...
			constexpr static uint32_t voltageMin = 6000;
			constexpr static uint32_t voltageMax = 7400;

			constexpr static uint32_t voltageDividerR1 = 1000000;
			constexpr static uint32_t voltageDividerR2 = 330000;
		}
